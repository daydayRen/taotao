<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <script type="text/javascript"> 
    ...
    <script language='javascript' src="/js/base-v1.js" charset="utf-8"></script> 
	...
	<div class="w" id="header-2013">
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					<input type="text" class="text" accesskey="s" id="key" autocomplete="off" onkeydown="javascript:if(event.keyCode==13) search2('key');">
					<input type="button" value="搜索" class="button" onclick="search2('key');return false;" clstag="homepage|keycount|home2013|03a">
				</div>
			</div>
